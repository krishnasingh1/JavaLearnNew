...
Also, we will learn to clear the input buffer. Your task is to take input of strings
and integers and produce the output. We must be clear with next() and nextLine()

Note : Refer the following link to get better understanding: StackOverflow

Input Format:
First line of input contains T,  number of testcases. For each testcase,
there will be two lines of input. First line contains integer, second
