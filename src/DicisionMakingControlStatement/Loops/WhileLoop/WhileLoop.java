...
public class WhileLoop {
    public static void main(String[] args) {
        ...
        System.out.println("Printing the list of the first 10 even numbers \n");
...
/*
        Java while loop --> The while loop is also used to iterate over the number of statements multiple times. However, if we don't
